		...
		<!-- S = ShowAllCategory -->
			<div class="allCategoriesPan">
				...
				<div class="content" id="location" >
					<div  v-for="(itemCat,index) in itemCats" :key="index" class="fenlei" id="baihuo">	
						<dt>
			           		<a  target="_blank" href="/jiaju/" class="titlefont" v-text="itemCat.categoryname"></a>
			                  <br />                          
			             </dt>
			                <dd class="marginLeft" >
			                  <a target="_blank" v-for="subItemCat in itemCat.itemCat" href="/chuangdian/" v-text="subItemCat.categoryname + '    '"></a>
			               </dd>
			            </dl>
			        </div>
